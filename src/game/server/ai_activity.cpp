...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_READY_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_READY_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_READY_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_READY_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_READY_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_AIM_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_AIM_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_AIM_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_AIM_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_AIM_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_AIM_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_AIM_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_CROUCH_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_PRONE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_SLIDE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_CROUCH_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_PRONE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_SLIDE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_CROUCH_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_PRONE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_SLIDE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_CROUCH_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_PRONE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_SLIDE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_DIVE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_ROLL_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVESLIDE_M3 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_TO_STAND_M3 );
