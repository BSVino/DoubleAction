...
//===========================
	...
	// Positions
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_READY_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_READY_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_READY_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_READY_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_READY_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_CROUCH_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_PRONE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_SLIDE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_CROUCH_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_PRONE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_SLIDE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_DIVE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_ROLL_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVESLIDE_P99 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_TO_STAND_P99 );
