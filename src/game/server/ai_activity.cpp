...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_AIM_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_AIM_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_AIM_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_AIM_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_AIM_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_AIM_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_AIM_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_CROUCH_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_PRONE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_SLIDE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART_MPL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE_MPL );
