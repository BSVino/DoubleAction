...
#ifndef CF_BOT_CHATTER_H
#define CF_BOT_CHATTER_H
...
{
public:
	void Transmit( CDABot *sender ) const;									///< transmit meme to other bots
	virtual void Interpret( CDABot *sender, CDABot *receiver ) const = 0;	///< cause the given bot to act on this meme
};
...
public:
	...
	virtual void Interpret( CDABot *sender, CDABot *receiver ) const;		///< cause the given bot to act on this meme
...
public:
	...
	CDABot *GetOwner( void ) const							{ return m_me; }
...
private:
	...
	CDABot *m_me;														///< the bot this chatter is for
