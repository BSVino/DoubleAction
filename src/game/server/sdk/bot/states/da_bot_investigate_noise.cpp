 ...
 */
void InvestigateNoiseState::AttendCurrentNoise( CDABot *me )
{
...
//--------------------------------------------------------------------------------------------------------------
void InvestigateNoiseState::OnEnter( CDABot *me )
{
 ...
 */
void InvestigateNoiseState::OnUpdate( CDABot *me )
{
	...
	if (range < closeRange)
	{
		if (me->IsVisible( m_checkNoisePosition, true ))
		{
...
//--------------------------------------------------------------------------------------------------------------
void InvestigateNoiseState::OnExit( CDABot *me )
{
