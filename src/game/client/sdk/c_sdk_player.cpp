...
BEGIN_RECV_TABLE_NOBASE( CSDKPlayerShared, DT_SDKPlayerShared )
	...
	RecvPropInt (RECVINFO (climbcnt)),
	RecvPropFloat (RECVINFO (climbtime)),
	RecvPropInt (RECVINFO (kongcnt)),
	RecvPropFloat (RECVINFO (kongtime)),
	RecvPropFloat (RECVINFO (runtime)),
	RecvPropVector (RECVINFO (rundir)),
	RecvPropFloat (RECVINFO (wallscalar)),
	RecvPropBool (RECVINFO (somersault)),
	RecvPropInt (RECVINFO (daflags)),
	RecvPropFloat (RECVINFO (manteldist)),
	RecvPropVector (RECVINFO (wallnormal)),
	RecvPropTime (RECVINFO (fliptime)),
	RecvPropVector (RECVINFO (flipdir)),
END_RECV_TABLE()
...
BEGIN_PREDICTION_DATA_NO_BASE( CSDKPlayerShared )
	...
	DEFINE_PRED_FIELD (climbcnt, FIELD_INTEGER, FTYPEDESC_INSENDTABLE),
	DEFINE_PRED_FIELD (climbtime, FIELD_FLOAT, FTYPEDESC_INSENDTABLE),
	...
	DEFINE_PRED_FIELD (wallscalar, FIELD_FLOAT, FTYPEDESC_INSENDTABLE),
	DEFINE_PRED_FIELD (somersault, FIELD_BOOLEAN, FTYPEDESC_INSENDTABLE),
	DEFINE_PRED_FIELD (daflags, FIELD_INTEGER, FTYPEDESC_INSENDTABLE),
	DEFINE_PRED_FIELD (manteldist, FIELD_FLOAT, FTYPEDESC_INSENDTABLE),
	DEFINE_PRED_FIELD (wallnormal, FIELD_VECTOR, FTYPEDESC_INSENDTABLE),
	DEFINE_PRED_FIELD (fliptime, FIELD_FLOAT, FTYPEDESC_INSENDTABLE),
	DEFINE_PRED_FIELD (flipdir, FIELD_VECTOR, FTYPEDESC_INSENDTABLE),
END_PREDICTION_DATA()
