...
BEGIN_RECV_TABLE_NOBASE( CSDKPlayerShared, DT_SDKPlayerShared )
	...
	//RecvPropInt (RECVINFO (acrostate)),
	//RecvPropFloat (RECVINFO (acrotime)),
END_RECV_TABLE()
...
BEGIN_PREDICTION_DATA_NO_BASE( CSDKPlayerShared )
	...
	//DEFINE_PRED_FIELD (acrostate, FIELD_INTEGER, FTYPEDESC_INSENDTABLE),
	//DEFINE_PRED_FIELD (acrotime, FIELD_FLOAT, FTYPEDESC_INSENDTABLE),
END_PREDICTION_DATA()
