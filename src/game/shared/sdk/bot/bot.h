 ...
 * but also may need to be derived from a more specific player class, such as CCFPlayer
 */
...
{
	CWeaponSDKBase *gun = GetActiveSDKWeapon();
...
{
	// if our field of view is less than 90, we're looking thru a scope (maybe only true for CF...)
