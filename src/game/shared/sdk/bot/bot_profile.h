...
public:
	...
	const BotProfile *GetRandomProfile( BotDifficultyType difficulty, int team, weapontype_t weaponType ) const;			///< return random unused profile that matches the given difficulty level
