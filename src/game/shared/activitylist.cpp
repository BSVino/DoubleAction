...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY ( ACT_MP_STAND_TO_SLIDE );
	REGISTER_SHARED_ACTIVITY ( ACT_MP_STAND_TO_ROLL );
	...
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_PRIMARYFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_PRIMARYFIRE_DEPLOYED );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_SLIDE_SECONDARYFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_ROLL_PRIMARYFIRE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_ROLL_PRIMARYFIRE_DEPLOYED );
	REGISTER_SHARED_ACTIVITY( ACT_MP_ATTACK_ROLL_SECONDARYFIRE );
	...
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_SLIDE_END );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_ROLL );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_ROLL_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_MP_RELOAD_ROLL_END );
