...
enum sdkteams_e
	...
	#define VEC_PRONE_HULL_MIN	DAGameRules()->GetSDKViewVectors()->m_vProneHullMin
	#define VEC_PRONE_HULL_MAX	DAGameRules()->GetSDKViewVectors()->m_vProneHullMax
	#define VEC_PRONE_VIEW DAGameRules()->GetSDKViewVectors()->m_vProneView
	...
	#define VEC_SLIDE_HULL_MIN	DAGameRules()->GetSDKViewVectors()->m_vSlideHullMin
	#define VEC_SLIDE_HULL_MAX	DAGameRules()->GetSDKViewVectors()->m_vSlideHullMax
	#define VEC_SLIDE_VIEW		DAGameRules()->GetSDKViewVectors()->m_vSlideView

	#define VEC_DIVE_HULL_MIN	DAGameRules()->GetSDKViewVectors()->m_vDiveHullMin
	#define VEC_DIVE_HULL_MAX	DAGameRules()->GetSDKViewVectors()->m_vDiveHullMax
	#define VEC_DIVE_VIEW		DAGameRules()->GetSDKViewVectors()->m_vDiveView
...
//--------------------------------------------------------------------------------------------------------
//
// Weapon IDs for all DA Game weapons
//
...
typedef enum
{
	...
	// Akimbo pistols
	DA_WEAPON_AKIMBO_M1911,
	DA_WEAPON_AKIMBO_BERETTA,
...
const char *WeaponIDToAlias( DAWeaponID id );
DAWeaponID AliasToWeaponID( const char *alias );
