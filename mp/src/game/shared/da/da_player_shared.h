...
class CDAPlayerShared
{
public:

#ifdef CLIENT_DLL
	friend class C_DAPlayer;
	typedef C_DAPlayer OuterClass;
	DECLARE_PREDICTABLE();
#else
	friend class CDAPlayer;
	typedef CDAPlayer OuterClass;
#endif

	DECLARE_EMBEDDED_NETWORKVAR()
	DECLARE_CLASS_NOBASE( CDAPlayerShared );
