...
public:
	...
	public:
		bool        m_bActive;
		CHandle<CDAPlayer> m_hShooter;
		float       m_flShotTime;
		Vector      m_vecOrigin;
		Vector      m_vecDirection;
		int         m_iPenetrations;
		DAWeaponID m_eWeaponID;
		CHandle<CWeaponDABase> m_hWeapon;
...
public:
	...
	CBullet MakeBullet(CDAPlayer* pShooter, const Vector& vecSrc, const Vector& vecDirection, DAWeaponID eWeapon, CWeaponDABase* pWeapon, int iDamage, int iBulletType, bool bDoEffects);
