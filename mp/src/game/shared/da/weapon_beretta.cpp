...
class CWeaponBeretta : public CWeaponDABase
{
public:
	DECLARE_CLASS( CWeaponBeretta, CWeaponDABase );
	...
	virtual DAWeaponID GetWeaponID( void ) const		{ return DA_WEAPON_BERETTA; }
...
acttable_t CWeaponBeretta::m_acttable[] = 
{
	...
	{ ACT_DA_WALLFLIP,                 ACT_DA_WALLFLIP_BERETTA,               false },
};
