	...
	float timer )
{
	...
	pGrenade->m_flDamage = CSDKWeaponInfo::GetWeaponInfo(DA_WEAPON_GRENADE)->m_iDamage;
...
void CWeaponGrenade::EmitGrenade( Vector vecSrc, QAngle vecAngles, Vector vecVel, AngularImpulse angImpulse, CBasePlayer *pPlayer, CWeaponDABase *pWeapon )
{
