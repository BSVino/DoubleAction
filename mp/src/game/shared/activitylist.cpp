...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_READY );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_READY );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_READY );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_READY );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_READY );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CRAWL_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DRAW );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_DIVE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_ROLL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_LOOP_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_LOOP_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_LOOP_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_END );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_END_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_END_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_END_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_DIVE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_ROLL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_START );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_FLOAT );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_LAND );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEFALL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEROLL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_ROLL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDESTART );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVESLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONE_TO_STAND );

	// Positions
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_READY_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_READY_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_READY_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_READY_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_READY_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CRAWL_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DRAW_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_CROUCH_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_PRONE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_SLIDE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_DIVE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_ROLL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_CROUCH_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_PRONE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_SLIDE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_CROUCH_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_PRONE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_SLIDE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_DIVE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_ROLL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_START_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_FLOAT_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_LAND_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEFALL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEROLL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_ROLL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDESTART_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVESLIDE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONE_TO_STAND_BERETTA );

	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_READY_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_READY_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_READY_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_READY_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_READY_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CRAWL_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DRAW_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_CROUCH_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_PRONE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_SLIDE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_DIVE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_ROLL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_CROUCH_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_PRONE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_SLIDE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_CROUCH_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_PRONE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_SLIDE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_DIVE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_ROLL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_START_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_FLOAT_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_LAND_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEFALL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEROLL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_ROLL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDESTART_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVESLIDE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONE_TO_STAND_M1911 );

	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_READY_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_READY_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_READY_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_READY_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_READY_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CRAWL_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONE_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DRAW_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_CROUCH_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_PRONE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_SLIDE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_DIVE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_ROLL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_CROUCH_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_PRONE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_SLIDE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_CROUCH_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_PRONE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_SLIDE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_DIVE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_ROLL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_START_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_FLOAT_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_LAND_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEFALL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEROLL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_ROLL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDESTART_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVESLIDE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONE_TO_STAND_MP5K );

	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_IDLE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_IDLE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_IDLE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_IDLE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_IDLE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_READY_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_READY_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_READY_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_READY_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_READY_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_IDLE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_IDLE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CRAWL_IDLE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_AIM_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_AIM_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_AIM_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_AIM_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_AIM_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_AIM_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_AIM_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DRAW_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_CROUCH_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_PRONE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_SLIDE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_DIVE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_ROLL_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_CROUCH_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_PRONE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_SLIDE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_CROUCH_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_PRONE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_SLIDE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_DIVE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_ROLL_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_START_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_FLOAT_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_LAND_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEFALL_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEROLL_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_ROLL_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDESTART_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVESLIDE_VECTOR );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONE_TO_STAND_VECTOR );

	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_READY_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_READY_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_READY_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_READY_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_READY_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CRAWL_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DRAW_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_CROUCH_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_PRONE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_DIVE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_ROLL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_CROUCH_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_PRONE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_LOOP_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_LOOP_CROUCH_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_LOOP_PRONE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_LOOP_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_END_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_END_CROUCH_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_END_PRONE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_END_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_CROUCH_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_PRONE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_DIVE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_ROLL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_START_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_FLOAT_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_LAND_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEFALL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEROLL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_ROLL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDESTART_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVESLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONE_TO_STAND_MOSSBERG );

	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_READY_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_READY_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_READY_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_READY_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_READY_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CRAWL_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DRAW_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_CROUCH_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_PRONE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_SLIDE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_DIVE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_ROLL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_CROUCH_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_PRONE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RELOAD_SLIDE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_CROUCH_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_PRONE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_SLIDE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_DIVE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_ROLL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_START_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_FLOAT_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_LAND_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEFALL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEROLL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_ROLL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDESTART_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVESLIDE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONE_TO_STAND_FAL );

	REGISTER_SHARED_ACTIVITY( ACT_DAB_STAND_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_WALK_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_RUN_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCH_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CROUCHWALK_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONECHEST_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONEBACK_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_CRAWL_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DRAW_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_CROUCH_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_PRONE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_SLIDE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_DIVE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRIMARYATTACK_ROLL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_CROUCH_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_PRONE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_SLIDE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_DIVE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_BRAWL_ROLL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_START_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_FLOAT_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_JUMP_LAND_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEFALL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVEROLL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_ROLL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDESTART_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_SLIDE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_DIVESLIDE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DAB_PRONE_TO_STAND_GRENADE );

	REGISTER_SHARED_ACTIVITY(ACT_DAB_STAND_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_WALK_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RUN_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCH_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCHWALK_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_STAND_READY_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_WALK_READY_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RUN_READY_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCH_READY_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCHWALK_READY_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRONECHEST_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRONEBACK_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CRAWL_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_STAND_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_WALK_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RUN_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCH_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCHWALK_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRONECHEST_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRONEBACK_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_DRAW_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_CROUCH_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_PRONE_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_SLIDE_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_DIVE_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_ROLL_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_CROUCH_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_PRONE_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_SLIDE_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_DIVE_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_ROLL_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RELOAD_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RELOAD_CROUCH_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RELOAD_PRONE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RELOAD_SLIDE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_CROUCH_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_PRONE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_SLIDE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_DIVE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_ROLL_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_JUMP_START_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_JUMP_FLOAT_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_JUMP_LAND_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_DIVE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_DIVEFALL_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_DIVEROLL_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_ROLL_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_SLIDESTART_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_SLIDE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_DIVESLIDE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRONE_TO_STAND_AKIMBO_M1911);

	REGISTER_SHARED_ACTIVITY(ACT_DAB_STAND_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_WALK_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RUN_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCH_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCHWALK_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_STAND_READY_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_WALK_READY_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RUN_READY_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCH_READY_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCHWALK_READY_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRONECHEST_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRONEBACK_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CRAWL_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_STAND_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_WALK_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RUN_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCH_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_CROUCHWALK_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRONECHEST_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRONEBACK_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_DRAW_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_CROUCH_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_PRONE_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_SLIDE_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_DIVE_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_ROLL_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_CROUCH_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_PRONE_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_SLIDE_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_DIVE_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRIMARYATTACK_ROLL_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RELOAD_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RELOAD_CROUCH_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RELOAD_PRONE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_RELOAD_SLIDE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_CROUCH_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_PRONE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_SLIDE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_DIVE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_BRAWL_ROLL_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_JUMP_START_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_JUMP_FLOAT_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_JUMP_LAND_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_DIVE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_DIVEFALL_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_DIVEROLL_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_ROLL_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_SLIDESTART_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_SLIDE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_DIVESLIDE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_PRONE_TO_STAND_AKIMBO_BERETTA);

	REGISTER_SHARED_ACTIVITY(ACT_DAB_VAULT);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_WALLCLIMB);
	REGISTER_SHARED_ACTIVITY(ACT_DAB_WALLFLIP);
