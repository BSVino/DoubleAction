...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_IDLE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_IDLE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_IDLE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_IDLE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_IDLE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_READY_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_READY_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_READY_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_READY_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_READY_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONECHEST_IDLE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONEBACK_IDLE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DRAW_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_CROUCH_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_PRONE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_SLIDE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_DIVE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_ROLL_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_CROUCH_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_PRONE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_SLIDE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_CROUCH_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_PRONE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_SLIDE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_DIVE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_ROLL_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_START_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_FLOAT_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_LAND_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVEFALL_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVEROLL_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_ROLL_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_SLIDESTART_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_SLIDE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVESLIDE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONE_TO_STAND_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_THROW_GRENADE_PLAN_D);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_PLAN_D);
