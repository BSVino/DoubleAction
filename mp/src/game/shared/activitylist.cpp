...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_READY );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_READY );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_READY );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_READY );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_READY );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_IDLE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_AIM );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DRAW );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_DIVE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_ROLL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_LOOP );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_LOOP_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_LOOP_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_LOOP_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_END );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_END_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_END_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_END_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_CROUCH );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_PRONE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_DIVE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_ROLL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_START );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_FLOAT );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_LAND );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEFALL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEROLL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_ROLL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDESTART );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVESLIDE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONE_TO_STAND );
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP);

	// Positions
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_READY_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_READY_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_READY_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_READY_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_READY_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_IDLE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DRAW_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_CROUCH_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_PRONE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_SLIDE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_DIVE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_ROLL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_CROUCH_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_PRONE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_SLIDE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_CROUCH_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_PRONE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_SLIDE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_DIVE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_ROLL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_START_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_FLOAT_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_LAND_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEFALL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEROLL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_ROLL_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDESTART_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVESLIDE_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONE_TO_STAND_BERETTA );
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE_BERETTA );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_BERETTA);

	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_READY_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_READY_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_READY_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_READY_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_READY_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_IDLE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DRAW_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_CROUCH_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_PRONE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_SLIDE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_DIVE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_ROLL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_CROUCH_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_PRONE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_SLIDE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_CROUCH_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_PRONE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_SLIDE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_DIVE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_ROLL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_START_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_FLOAT_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_LAND_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEFALL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEROLL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_ROLL_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDESTART_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVESLIDE_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONE_TO_STAND_M1911 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE_M1911 );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_M1911);

	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_READY_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_READY_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_READY_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_READY_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_READY_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_IDLE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONE_AIM_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DRAW_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_CROUCH_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_PRONE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_SLIDE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_DIVE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_ROLL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_CROUCH_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_PRONE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_SLIDE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_CROUCH_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_PRONE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_SLIDE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_DIVE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_ROLL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_START_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_FLOAT_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_LAND_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEFALL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEROLL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_ROLL_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDESTART_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVESLIDE_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONE_TO_STAND_MP5K );
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE_MP5K );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_MP5K);

	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_IDLE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_IDLE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_IDLE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_IDLE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_IDLE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_READY_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_READY_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_READY_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_READY_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_READY_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_IDLE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_IDLE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_AIM_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_AIM_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_AIM_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_AIM_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_AIM_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_AIM_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_AIM_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DRAW_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_CROUCH_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_PRONE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_SLIDE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_DIVE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_ROLL_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_CROUCH_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_PRONE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_SLIDE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_CROUCH_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_PRONE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_SLIDE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_DIVE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_ROLL_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_START_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_FLOAT_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_LAND_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEFALL_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEROLL_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_ROLL_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDESTART_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVESLIDE_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONE_TO_STAND_MAC10 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE_MAC10 );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_MAC10);

	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_READY_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_READY_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_READY_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_READY_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_READY_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_IDLE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_AIM_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DRAW_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_CROUCH_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_PRONE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_DIVE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_ROLL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_CROUCH_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_PRONE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_LOOP_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_LOOP_CROUCH_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_LOOP_PRONE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_LOOP_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_END_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_END_CROUCH_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_END_PRONE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_END_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_CROUCH_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_PRONE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_DIVE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_ROLL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_START_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_FLOAT_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_LAND_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEFALL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEROLL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_ROLL_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDESTART_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVESLIDE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONE_TO_STAND_MOSSBERG );
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE_MOSSBERG );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_MOSSBERG);

	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_IDLE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_IDLE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_IDLE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_IDLE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_IDLE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_READY_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_READY_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_READY_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_READY_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_READY_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONECHEST_IDLE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONEBACK_IDLE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_AIM_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_AIM_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_AIM_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_AIM_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_AIM_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONECHEST_AIM_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONEBACK_AIM_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DRAW_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_CROUCH_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_PRONE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_SLIDE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_DIVE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_ROLL_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_CROUCH_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_PRONE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_SLIDE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_LOOP_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_LOOP_CROUCH_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_LOOP_PRONE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_LOOP_SLIDE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_END_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_END_CROUCH_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_END_PRONE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_END_SLIDE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_CROUCH_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_PRONE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_SLIDE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_DIVE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_ROLL_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_START_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_FLOAT_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_LAND_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVEFALL_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVEROLL_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_ROLL_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_SLIDESTART_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_SLIDE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVESLIDE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONE_TO_STAND_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_THROW_GRENADE_SAWNOFF);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_SAWNOFF);

	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_READY_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_READY_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_READY_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_READY_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_READY_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_IDLE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_AIM_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DRAW_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_CROUCH_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_PRONE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_SLIDE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_DIVE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_ROLL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_CROUCH_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_PRONE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_SLIDE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_CROUCH_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_PRONE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_SLIDE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_DIVE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_ROLL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_START_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_FLOAT_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_LAND_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEFALL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEROLL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_ROLL_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDESTART_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVESLIDE_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONE_TO_STAND_FAL );
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE_FAL );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_FAL);

	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_IDLE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DRAW_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_CROUCH_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_PRONE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_SLIDE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_DIVE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_ROLL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_CROUCH_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_PRONE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_SLIDE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_DIVE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_ROLL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_START_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_FLOAT_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_LAND_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEFALL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEROLL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_ROLL_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDESTART_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVESLIDE_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONE_TO_STAND_GRENADE );
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE_GRENADE );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_GRENADE);

	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_READY_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_READY_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_READY_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_READY_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_READY_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONECHEST_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONEBACK_IDLE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONECHEST_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONEBACK_AIM_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DRAW_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_CROUCH_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_PRONE_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_SLIDE_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_DIVE_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_ROLL_AKIMBO_M1911_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_CROUCH_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_PRONE_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_SLIDE_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_DIVE_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_ROLL_AKIMBO_M1911_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_CROUCH_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_PRONE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_SLIDE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_CROUCH_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_PRONE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_SLIDE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_DIVE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_ROLL_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_START_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_FLOAT_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_LAND_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVEFALL_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVEROLL_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_ROLL_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_SLIDESTART_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_SLIDE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVESLIDE_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONE_TO_STAND_AKIMBO_M1911);
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE_AKIMBO_M1911 );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_AKIMBO_M1911);

	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_READY_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_READY_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_READY_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_READY_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_READY_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONECHEST_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONEBACK_IDLE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_STAND_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALK_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RUN_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCH_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_CROUCHWALK_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONECHEST_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONEBACK_AIM_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DRAW_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_CROUCH_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_PRONE_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_SLIDE_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_DIVE_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_ROLL_AKIMBO_BERETTA_LEFT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_CROUCH_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_PRONE_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_SLIDE_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_DIVE_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRIMARYATTACK_ROLL_AKIMBO_BERETTA_RIGHT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_CROUCH_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_PRONE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_RELOAD_SLIDE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_CROUCH_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_PRONE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_SLIDE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_DIVE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_BRAWL_ROLL_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_START_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_FLOAT_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_JUMP_LAND_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVEFALL_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVEROLL_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_ROLL_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_SLIDESTART_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_SLIDE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_DIVESLIDE_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY(ACT_DA_PRONE_TO_STAND_AKIMBO_BERETTA);
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE_AKIMBO_BERETTA );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_AKIMBO_BERETTA);

	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_IDLE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_IDLE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_IDLE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_IDLE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_IDLE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_READY_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_READY_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_READY_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_READY_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_READY_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_IDLE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_IDLE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_STAND_AIM_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_WALK_AIM_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RUN_AIM_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCH_AIM_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_CROUCHWALK_AIM_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONECHEST_AIM_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONEBACK_AIM_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DRAW_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_CROUCH_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_PRONE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_SLIDE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_DIVE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRIMARYATTACK_ROLL_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_CROUCH_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_PRONE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_RELOAD_SLIDE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_CROUCH_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_PRONE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_SLIDE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_DIVE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_BRAWL_ROLL_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_START_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_FLOAT_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_JUMP_LAND_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEFALL_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVEROLL_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_ROLL_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDESTART_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_SLIDE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_DIVESLIDE_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_PRONE_TO_STAND_M16 );
	REGISTER_SHARED_ACTIVITY( ACT_DA_THROW_GRENADE_M16 );
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLFLIP_M16);

	REGISTER_SHARED_ACTIVITY(ACT_DA_VAULT);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLCLIMB);
	REGISTER_SHARED_ACTIVITY(ACT_DA_WALLRUN);
