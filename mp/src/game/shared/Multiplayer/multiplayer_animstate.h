...
enum PlayerAnimEvent_t
{
	...
	PLAYERANIMEVENT_STAND_TO_SLIDE,
	PLAYERANIMEVENT_STAND_TO_ROLL,

	PLAYERANIMEVENT_STAND_TO_VAULT,
	PLAYERANIMEVENT_STAND_TO_WALLRUN,
	PLAYERANIMEVENT_WALLFLIP,
	PLAYERANIMEVENT_WALLCLIMB,
