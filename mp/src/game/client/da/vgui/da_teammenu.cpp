...
CDATeamMenu::CDATeamMenu(Panel *parent) : CFolderMenuPanel( parent, PANEL_TEAM )
{
...
//Destructor
CDATeamMenu::~CDATeamMenu()
{
}

void CDATeamMenu::ApplySettings( KeyValues *resourceData )
{
	BaseClass::ApplySettings( resourceData );
}

void CDATeamMenu::Reset()
{
}

void CDATeamMenu::ShowPanel( bool bShow )
{
	if ( bShow )
...
void CDATeamMenu::OnKeyCodePressed( KeyCode code )
{
...
void CDATeamMenu::UpdateCharacter(CModelPanel* pPanel)
{
	C_DAPlayer *pPlayer = C_DAPlayer::GetLocalDAPlayer();
...
Panel *CDATeamMenu::CreateControlByName( const char *controlName )
{
...
// Purpose: 
//-----------------------------------------------------------------------------
void CDATeamMenu::SetVisible(bool state)
{
...
//-----------------------------------------------------------------------------
void CDATeamMenu::OnCommand( const char *command )
{
	if ( Q_strncmp( command, "jointeam ", 9 ) == 0 )
	{
		...
		if (C_DAPlayer::GetLocalDAPlayer())
			C_DAPlayer::GetLocalDAPlayer()->m_iTeamNum = atoi(command+9);
...
//-----------------------------------------------------------------------------
void CDATeamMenu::PaintBackground()
{
}
...
//-----------------------------------------------------------------------------
void CDATeamMenu::ApplySchemeSettings( vgui::IScheme *pScheme )
{
