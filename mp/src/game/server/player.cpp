...
ConVar	spec_freeze_traveltime( "spec_freeze_traveltime", "0.0", FCVAR_CHEAT | FCVAR_REPLICATED, "Time taken to zoom in to frame a target in observer freeze cam.", true, 0.01, false, 0 );
#endif
