...
void FinishClientPutInServer( CDAPlayer *pPlayer )
{
...
void ClientPutInServer( edict_t *pEdict, const char *playername )
{
	...
	CDAPlayer *pPlayer = CDAPlayer::CreatePlayer( "player", pEdict );
...
void ClientActive( edict_t *pEdict, bool bLoadGame )
{
	...
	CDAPlayer *pPlayer = ToDAPlayer( CBaseEntity::Instance( pEdict ) );
...
{
	CreateGameRulesObject( "CDAGameRules" );
}
