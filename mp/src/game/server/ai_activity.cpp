...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_READY );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_READY );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_READY );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_READY );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_READY );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DRAW );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_DIVE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_ROLL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVESLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_TO_STAND );

	// Positions
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_READY_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_READY_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_READY_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_READY_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_READY_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DRAW_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_CROUCH_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_PRONE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_SLIDE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_CROUCH_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_PRONE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_SLIDE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_DIVE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_ROLL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVESLIDE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_TO_STAND_BERETTA );

	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_READY_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_READY_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_READY_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_READY_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_READY_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DRAW_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_CROUCH_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_PRONE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_SLIDE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_CROUCH_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_PRONE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_SLIDE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_DIVE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_ROLL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVESLIDE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_TO_STAND_M1911 );

	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_READY_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_READY_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_READY_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_READY_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_READY_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DRAW_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_CROUCH_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_PRONE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_SLIDE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_CROUCH_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_PRONE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_SLIDE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_DIVE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_ROLL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVESLIDE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_TO_STAND_MP5K );

	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_READY_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_READY_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_READY_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_READY_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_READY_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_AIM_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_AIM_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_AIM_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_AIM_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_AIM_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_AIM_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_AIM_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DRAW_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_CROUCH_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_PRONE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_SLIDE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_CROUCH_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_PRONE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_SLIDE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_DIVE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_ROLL_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVESLIDE_VECTOR );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_TO_STAND_VECTOR );

	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_READY_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_READY_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_READY_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_READY_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_READY_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DRAW_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_CROUCH_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_PRONE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_CROUCH_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_PRONE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_LOOP_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_CROUCH_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_PRONE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_END_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_CROUCH_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_PRONE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_DIVE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_ROLL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVESLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_TO_STAND_MOSSBERG );

	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_READY_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_READY_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_READY_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_READY_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_READY_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DRAW_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_CROUCH_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_PRONE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RELOAD_SLIDE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_CROUCH_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_PRONE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_SLIDE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_DIVE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_ROLL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVESLIDE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_TO_STAND_FAL );

	ADD_ACTIVITY_TO_SR( ACT_DAB_STAND_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_WALK_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_RUN_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCH_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CROUCHWALK_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONECHEST_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONEBACK_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_CRAWL_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DRAW_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_CROUCH_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_PRONE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_SLIDE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_DIVE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRIMARYATTACK_ROLL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_CROUCH_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_PRONE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_SLIDE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_DIVE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_BRAWL_ROLL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_START_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_FLOAT_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_JUMP_LAND_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEFALL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVEROLL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_ROLL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDESTART_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_SLIDE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_DIVESLIDE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DAB_PRONE_TO_STAND_GRENADE );

	ADD_ACTIVITY_TO_SR(ACT_DAB_STAND_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_WALK_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RUN_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCH_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCHWALK_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_STAND_READY_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_WALK_READY_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RUN_READY_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCH_READY_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCHWALK_READY_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRONECHEST_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRONEBACK_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CRAWL_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_STAND_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_WALK_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RUN_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCH_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCHWALK_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRONECHEST_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRONEBACK_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_DRAW_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_CROUCH_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_PRONE_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_SLIDE_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_DIVE_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_ROLL_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_CROUCH_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_PRONE_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_SLIDE_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_DIVE_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_ROLL_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RELOAD_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RELOAD_CROUCH_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RELOAD_PRONE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RELOAD_SLIDE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_CROUCH_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_PRONE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_SLIDE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_DIVE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_ROLL_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_JUMP_START_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_JUMP_FLOAT_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_JUMP_LAND_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_DIVE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_DIVEFALL_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_DIVEROLL_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_ROLL_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_SLIDESTART_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_SLIDE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_DIVESLIDE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRONE_TO_STAND_AKIMBO_M1911);

	ADD_ACTIVITY_TO_SR(ACT_DAB_STAND_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_WALK_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RUN_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCH_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCHWALK_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_STAND_READY_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_WALK_READY_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RUN_READY_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCH_READY_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCHWALK_READY_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRONECHEST_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRONEBACK_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CRAWL_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_STAND_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_WALK_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RUN_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCH_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_CROUCHWALK_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRONECHEST_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRONEBACK_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_DRAW_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_CROUCH_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_PRONE_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_SLIDE_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_DIVE_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_ROLL_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_CROUCH_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_PRONE_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_SLIDE_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_DIVE_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRIMARYATTACK_ROLL_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RELOAD_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RELOAD_CROUCH_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RELOAD_PRONE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_RELOAD_SLIDE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_CROUCH_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_PRONE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_SLIDE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_DIVE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_BRAWL_ROLL_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_JUMP_START_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_JUMP_FLOAT_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_JUMP_LAND_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_DIVE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_DIVEFALL_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_DIVEROLL_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_ROLL_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_SLIDESTART_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_SLIDE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_DIVESLIDE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DAB_PRONE_TO_STAND_AKIMBO_BERETTA);

	ADD_ACTIVITY_TO_SR(ACT_DAB_VAULT);
	ADD_ACTIVITY_TO_SR(ACT_DAB_WALLCLIMB);
	ADD_ACTIVITY_TO_SR(ACT_DAB_WALLFLIP);
	ADD_ACTIVITY_TO_SR(ACT_DAB_WALLRUN);
