...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_READY );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_READY );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_READY );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_READY );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_READY );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_IDLE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_AIM );
	ADD_ACTIVITY_TO_SR( ACT_DA_DRAW );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_DIVE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_ROLL );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_LOOP );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_LOOP_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_LOOP_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_LOOP_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_END );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_END_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_END_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_END_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_CROUCH );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_PRONE );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_DIVE );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_ROLL );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_START );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_FLOAT );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_LAND );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVE );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEFALL );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEROLL );
	ADD_ACTIVITY_TO_SR( ACT_DA_ROLL );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDESTART );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVESLIDE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONE_TO_STAND );
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP);

	// Positions
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_READY_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_READY_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_READY_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_READY_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_READY_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_IDLE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_DRAW_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_CROUCH_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_PRONE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_SLIDE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_DIVE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_ROLL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_CROUCH_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_PRONE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_SLIDE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_CROUCH_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_PRONE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_SLIDE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_DIVE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_ROLL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_START_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_FLOAT_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_LAND_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEFALL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEROLL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_ROLL_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDESTART_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVESLIDE_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONE_TO_STAND_BERETTA );
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE_BERETTA );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_BERETTA);

	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_READY_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_READY_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_READY_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_READY_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_READY_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_IDLE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DRAW_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_CROUCH_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_PRONE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_SLIDE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_DIVE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_ROLL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_CROUCH_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_PRONE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_SLIDE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_CROUCH_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_PRONE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_SLIDE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_DIVE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_ROLL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_START_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_FLOAT_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_LAND_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEFALL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEROLL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_ROLL_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDESTART_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVESLIDE_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONE_TO_STAND_M1911 );
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE_M1911 );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_M1911);

	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_READY_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_READY_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_READY_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_READY_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_READY_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_IDLE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONE_AIM_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_DRAW_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_CROUCH_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_PRONE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_SLIDE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_DIVE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_ROLL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_CROUCH_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_PRONE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_SLIDE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_CROUCH_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_PRONE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_SLIDE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_DIVE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_ROLL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_START_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_FLOAT_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_LAND_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEFALL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEROLL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_ROLL_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDESTART_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVESLIDE_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONE_TO_STAND_MP5K );
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE_MP5K );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_MP5K);

	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_IDLE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_IDLE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_IDLE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_IDLE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_IDLE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_READY_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_READY_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_READY_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_READY_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_READY_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_IDLE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_IDLE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_AIM_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_AIM_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_AIM_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_AIM_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_AIM_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_AIM_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_AIM_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DRAW_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_CROUCH_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_PRONE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_SLIDE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_DIVE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_ROLL_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_CROUCH_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_PRONE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_SLIDE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_CROUCH_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_PRONE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_SLIDE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_DIVE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_ROLL_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_START_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_FLOAT_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_LAND_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEFALL_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEROLL_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_ROLL_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDESTART_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVESLIDE_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONE_TO_STAND_MAC10 );
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE_MAC10 );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_MAC10);

	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_READY_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_READY_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_READY_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_READY_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_READY_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_IDLE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_AIM_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_DRAW_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_CROUCH_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_PRONE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_DIVE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_ROLL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_CROUCH_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_PRONE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_LOOP_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_LOOP_CROUCH_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_LOOP_PRONE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_LOOP_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_END_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_END_CROUCH_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_END_PRONE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_END_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_CROUCH_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_PRONE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_DIVE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_ROLL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_START_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_FLOAT_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_LAND_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEFALL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEROLL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_ROLL_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDESTART_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVESLIDE_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONE_TO_STAND_MOSSBERG );
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE_MOSSBERG );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_MOSSBERG);

	ADD_ACTIVITY_TO_SR(ACT_DA_STAND_IDLE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALK_IDLE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RUN_IDLE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCH_IDLE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCHWALK_IDLE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_STAND_READY_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALK_READY_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RUN_READY_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCH_READY_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCHWALK_READY_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONECHEST_IDLE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONEBACK_IDLE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_STAND_AIM_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALK_AIM_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RUN_AIM_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCH_AIM_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCHWALK_AIM_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONECHEST_AIM_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONEBACK_AIM_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_DRAW_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_CROUCH_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_PRONE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_SLIDE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_DIVE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_ROLL_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_CROUCH_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_PRONE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_SLIDE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_LOOP_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_LOOP_CROUCH_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_LOOP_PRONE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_LOOP_SLIDE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_END_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_END_CROUCH_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_END_PRONE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_END_SLIDE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_CROUCH_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_PRONE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_SLIDE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_DIVE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_ROLL_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_JUMP_START_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_JUMP_FLOAT_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_JUMP_LAND_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVEFALL_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVEROLL_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_ROLL_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_SLIDESTART_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_SLIDE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVESLIDE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONE_TO_STAND_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_THROW_GRENADE_SAWNOFF);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_SAWNOFF);

	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_READY_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_READY_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_READY_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_READY_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_READY_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_IDLE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_AIM_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_DRAW_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_CROUCH_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_PRONE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_SLIDE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_DIVE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_ROLL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_CROUCH_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_PRONE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_SLIDE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_CROUCH_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_PRONE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_SLIDE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_DIVE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_ROLL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_START_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_FLOAT_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_LAND_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEFALL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEROLL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_ROLL_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDESTART_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVESLIDE_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONE_TO_STAND_FAL );
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE_FAL );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_FAL);

	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_IDLE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_DRAW_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_CROUCH_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_PRONE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_SLIDE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_DIVE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_ROLL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_CROUCH_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_PRONE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_SLIDE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_DIVE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_ROLL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_START_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_FLOAT_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_LAND_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEFALL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEROLL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_ROLL_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDESTART_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVESLIDE_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONE_TO_STAND_GRENADE );
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE_GRENADE );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_GRENADE);

	ADD_ACTIVITY_TO_SR(ACT_DA_STAND_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALK_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_RUN_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCH_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCHWALK_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_STAND_READY_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALK_READY_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_RUN_READY_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCH_READY_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCHWALK_READY_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONECHEST_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONEBACK_IDLE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_STAND_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALK_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_RUN_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCH_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCHWALK_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONECHEST_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONEBACK_AIM_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_DRAW_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_CROUCH_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_PRONE_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_SLIDE_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_DIVE_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_ROLL_AKIMBO_M1911_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_CROUCH_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_PRONE_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_SLIDE_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_DIVE_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_ROLL_AKIMBO_M1911_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_CROUCH_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_PRONE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_SLIDE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_CROUCH_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_PRONE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_SLIDE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_DIVE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_ROLL_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_JUMP_START_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_JUMP_FLOAT_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_JUMP_LAND_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVEFALL_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVEROLL_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_ROLL_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_SLIDESTART_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_SLIDE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVESLIDE_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONE_TO_STAND_AKIMBO_M1911);
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE_AKIMBO_M1911 );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_AKIMBO_M1911);

	ADD_ACTIVITY_TO_SR(ACT_DA_STAND_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALK_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_RUN_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCH_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCHWALK_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_STAND_READY_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALK_READY_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_RUN_READY_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCH_READY_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCHWALK_READY_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONECHEST_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONEBACK_IDLE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_STAND_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALK_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_RUN_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCH_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_CROUCHWALK_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONECHEST_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONEBACK_AIM_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_DRAW_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_CROUCH_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_PRONE_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_SLIDE_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_DIVE_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_ROLL_AKIMBO_BERETTA_LEFT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_CROUCH_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_PRONE_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_SLIDE_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_DIVE_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRIMARYATTACK_ROLL_AKIMBO_BERETTA_RIGHT);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_CROUCH_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_PRONE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_RELOAD_SLIDE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_CROUCH_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_PRONE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_SLIDE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_DIVE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_BRAWL_ROLL_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_JUMP_START_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_JUMP_FLOAT_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_JUMP_LAND_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVEFALL_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVEROLL_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_ROLL_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_SLIDESTART_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_SLIDE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_DIVESLIDE_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR(ACT_DA_PRONE_TO_STAND_AKIMBO_BERETTA);
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE_AKIMBO_BERETTA );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_AKIMBO_BERETTA);

	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_IDLE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_IDLE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_IDLE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_IDLE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_IDLE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_READY_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_READY_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_READY_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_READY_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_READY_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_IDLE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_IDLE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_STAND_AIM_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_WALK_AIM_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RUN_AIM_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCH_AIM_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_CROUCHWALK_AIM_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONECHEST_AIM_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONEBACK_AIM_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DRAW_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_CROUCH_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_PRONE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_SLIDE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_DIVE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRIMARYATTACK_ROLL_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_CROUCH_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_PRONE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_RELOAD_SLIDE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_CROUCH_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_PRONE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_SLIDE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_DIVE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_BRAWL_ROLL_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_START_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_FLOAT_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_JUMP_LAND_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEFALL_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVEROLL_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_ROLL_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDESTART_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_SLIDE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_DIVESLIDE_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_PRONE_TO_STAND_M16 );
	ADD_ACTIVITY_TO_SR( ACT_DA_THROW_GRENADE_M16 );
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLFLIP_M16);

	ADD_ACTIVITY_TO_SR(ACT_DA_VAULT);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLCLIMB);
	ADD_ACTIVITY_TO_SR(ACT_DA_WALLRUN);

	ADD_ACTIVITY_TO_SR(ACT_DA_VM_FIRELAST);
	ADD_ACTIVITY_TO_SR(ACT_DA_VM_BRAWL);
	ADD_ACTIVITY_TO_SR(ACT_DA_VM_BRAWL_EMPTY);
}
